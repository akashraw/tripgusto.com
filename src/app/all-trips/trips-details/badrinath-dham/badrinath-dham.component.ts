...
@Component({
  selector: 'app-badrinath-dham',
  templateUrl: './badrinath-dham.component.html',
  styleUrls: ['./badrinath-dham.component.css']
})
export class BadrinathDhamComponent implements OnInit {
