...
export const TripData: TripClass[]  = [
  // Auli
    ...
    // badrinath-dham
    {
      ...
      route:'badrinath-dham',
      subtitle:'Pilgrim',
      avail:'May - November',
      Travel:'Travel Included',
      poster:"assets/images/product/badrinath-product.jpg",
      duration:'3D-2N',
      price:'9,999',
      ...
      Overview:{
        part1:`Badrinath Dham is dedicated to Lord Vishnu. A sacred deity in Hinduism. The temple is accessible by road and has an operation bust station at an altitude of 3133 meters above sea level. 
              ...
              The whole valley is full of meadows and scenic spots. Mata Murti Ka Mela, which commemorates the descent of the river Ganges on mother earth, is the most prominent festival celebrated in the Badrinath Temple. Although Badrinath is located in North India, the head priest, or Rawal, is traditionally a Nambudiri Brahmin chosen from the South Indian state of Kerala.`,
        part2:null, 
        part3:null, 
        part4:null,      
            },
    ...
    // char-dham
    {
      ...
      avail:'May-November',
      Travel:'Travel Included',
      poster:"assets/images/product/char-dham-product.jpg",
      duration:'11D-10N',
      price:'17,909',
      pdlocation:'Delhi',
      categor: 'Pilgrims',
    ...
    //Har Ki Dun
    {
      ...
      avail:'March-October',
      Travel:'Travel Included',
      poster:"assets/images/product/har-ki-dun-product.jpg",
      duration:'7D-6N',
      price:'11,999',
      pdlocation:'Dehradun',
      categor: 'Treks',
      ...
      costing:["₹12,999", "₹11,999"],
      occupancy:["Double Occupancy", "Triple Occupancy"]
    },
    //kasol-keerganga-weekend
    {
      id: 6,
      title:'Kasol Kheerganga',
      route:'kasol-keerganga-weekend',
      subtitle:'Weekend Getaway Trip',
      avail:'All year',
      Travel:'Travel Included',
      poster:"assets/images/product/kasol-keer-product.jpg",
      duration:'3D-2N',
      price:'4999',
      pdlocation:'Delhi',
      categor: 'Weekend Getaway Trips',
    ...
    //kasol-manali-back'
    {
      id: 7,
      title:'Kasol Manali',
      route:'kasol-manali-back',
      subtitle:'Backpacking Trip',
      avail:'All Year',
      Travel:'Travel Included',
      poster:'assets/images/product/kasol-manali-product.jpg',
      duration:'5D-4N',
      price:'10,499',
      pdlocation:'Delhi',
    ...
    {
      id: 8,
      title:'Kedarnath & Badrinath Dham',
      route:'kedar-badri-dham',
      avail:'May- November',
      subtitle:'Pilgrim',
      Travel:'Travel Included',
      poster:"assets/images/product/kedar-badri-product.jpg",
      duration:'5D-4N',
      price:'6,499',
      pdlocation:'Rishikesh',
      categor: 'Pilgrims',
    ...
    //kedarkantha-trek
    {
      id: 9,
      title:'Kedarkantha',
      route:'kedarkantha-trek',
      subtitle:'Trek',
      avail:'All Year',
      Travel:'Travel Included',
      poster:"assets/images/product/kedarkantha-product.jpg",
      duration:'5D-4N',
      price:'7,499',
      pdlocation:'Dehradun',
      categor: 'Treks',
    ...
    //kinnaur-valley
    {
      ...
      route:'kinnaur-valley',
      subtitle:'Backpacking Trip',
      avail:'All Year',
      Travel:'Travel Included',
      poster:"assets/images/product/kinnaur-product.jpg",
      duration:'5D-4N',
      price:'12,499',
      pdlocation:'Delhi',
      categor: 'Backpacking Trips',
      ...
      costing:["₹14,499", "₹12,499"], 
      occupancy:["Double Occupancy", "Triple Occupancy"]
    },
    //manali-kasol-trithan-back
    {
      id: 12,
      title:'Manali Kasol Tirthan Valley',
      route:'manali-kasol-trithan-back',
      subtitle:'Backpacking Trip',
      avail:'All Year',    
      Travel:'Travel Included',
      poster:"assets/images/product/kasol-manali-tirthan-product.jpg",
      duration:'5D-4N',
      price:'12,999',
      pdlocation:'Delhi',
      categor: 'Backpacking Trips',
    ...
    //parvati-valley Backpacking
    {
      ...
      route:'parvati-valley',
      subtitle:'Backpacking Trip',
      avail:'All Year',
      Travel:'Travel Included',
      poster:"assets/images/product/parvati-valley-product.jpg",
      duration:'5D-4N',
      price:'9,999',
      pdlocation:'Delhi',
      categor: 'Backpacking Trips',
...
`,
    ...
    {
      id: 16,
      title:'Tirthan Valley Trip',
      route:'trithan-valley',
      subtitle:'WEEKEND GETAWAY',
      avail:'All Year',
      Travel:'Travel Included',
      poster:"assets/images/product/tirthan-valley-product.jpg",
      duration:'3D-2N',
      price:'6499',
      pdlocation:'Delhi',
      categor: 'Weekend Getaway Trips',
    ...
    //valley-of-flowers
    {
      ...
      route:'valley-of-flowers',
      subtitle:'Backpacking Trip',
      avail:'All Year',
      Travel:'Travel Included',
      poster:"assets/images/product/valley-product.jpg",
      duration:'5D-4N',
      price:'7999',
      pdlocation:'Rishikesh',
      categor: 'Treks',
    ...
    //winter-spiti-back
    {
      id: 19,
      title:'Winter Spiti',
      route:'winter-spiti-back',
      subtitle:'Backpacking Trip',
      avail:'March-April',
      Travel:'Travel Included',
      poster:'assets/images/product/spiti-product.jpg',
      duration:'7D-6N',
      price:'16,499',
      pdlocation:'Delhi',
      categor: 'Backpacking Trips',
